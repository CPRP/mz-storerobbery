...
Config.PrintChanceRegister = 99                 -- Chance (in percentage) to leave fingerprints if not wearing gloves when robbing a register.
Config.PrintChanceSafe = 99                     -- Chance (in percentage) to leave fingerprints if not wearing gloves when robbing a safe.
...
Config.BreakRegister = "circle"                 -- Set to "standard" to use the qb-lockpick, "circle" uses the ps-ui minigame.
...
Config.SafeReqItem = "advancedlockpick"                     -- Change to any item you want (needs to be in qb-core/shared/items.lua)
...
Config.maxSafeEarn = 12000                      -- Maximum amount earnt from stealing from a safe (in dirtymoney)
...
--Rare item 1
Config.RareItem1 = "10kgoldchain"                      -- Name of the rare item that will drop
Config.RareItem1Chance = 20                     -- Percentage chance to obtain the rare item drop from robbing a safe.
Config.RareItemAmount = 3                       -- Amount of the rare item player will receive if chance is triggered
--Rare item 2 (Note: chance for drop is independent for each rare item listed)
Config.RareItem2 = "security_card_01"                    -- Name of the rare item that will drop
...
Config.RareItem3 = "weapon_smg"              -- Name of the rare item that will drop
